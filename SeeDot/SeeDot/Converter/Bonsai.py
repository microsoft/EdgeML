...
class BonsaiFixed(Bonsai):
	...
	def writeModelForHls(self):
		...
		SpDict = {}
		SpDict, maxJobSize, maxJobLen, offsetDict, indexDict, maxIndex = transformZ_offsetGen(Zidx,Zval, self.D,"Z")
...
class BonsaiFixedOld(BonsaiOld):
...
class BonsaiFloatOld(BonsaiOld):
