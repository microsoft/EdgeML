...
class Bonsai:
	...
	def readModel(self):
		...
		self.V = np.loadtxt(os.path.join(self.modelDir, "V"), delimiter="\t", ndmin=2)
		self.T = np.loadtxt(os.path.join(self.modelDir, "Theta"), delimiter="\t", ndmin=2)
		self.Sigma = np.loadtxt(os.path.join(self.modelDir, "Sigma"), delimiter="\t", ndmin=2)
		self.Mean = np.loadtxt(os.path.join(self.modelDir, "Mean"), delimiter="\t", ndmin=2)
		self.Variance = np.loadtxt(os.path.join(self.modelDir, "Variance"), delimiter="\t", ndmin=2)
