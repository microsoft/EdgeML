 ...
 * @param[in]       scl_a         Scaling factor for mat_in. shrA, shrB are used to bring matrices A and B to the same scale for addition
 * @param[in]       scl_b         Scaling factor for mat_bias. shrA, shrB are used to bring matrices A and B to the same scale for addition
 * @param[in]       scl_out       Scaling factor for mat_out. shrC adjusts the output matrix if required to prevent overflows
