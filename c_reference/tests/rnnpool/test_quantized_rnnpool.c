...
int main(int argc, char **argv) {
  ...
  Q15_FastGRNN_Scales rnn1_scales = {
    ...
    .mV1AddMV2Demote = mV1AddMV2Demote1,
    .pC1AddBg = pC1AddBg1,
    .Bg = BgScale1,
    .pC1AddBgOut = pC1AddBgOut1,
    .pC1AddBgDemote = pC1AddBgDemote1,
    ...
    .pC1AddBhDemote = pC1AddBhDemote1,
    ...
    .hiddenStateDemote = hiddenStateDemote1,
    .div = div1,
    .add = add1,
    .qOne = qOne1,
  ...
  Q15_FastGRNN_Scales rnn2_scales = {
    ...
    .mV1AddMV2Demote = mV1AddMV2Demote2,
    .pC1AddBg = pC1AddBg2,
    .Bg = BgScale2,
    .pC1AddBgOut = pC1AddBgOut2,
    .pC1AddBgDemote = pC1AddBgDemote2,
    ...
    .pC1AddBhDemote = pC1AddBhDemote2,
    ...
    .hiddenStateDemote = hiddenStateDemote2,
    .div = div2,
    .add = add2,
    .qOne = qOne2,
