...
static ITER_T useTableSigmoid1 = 0;
static ITER_T useTableTanH1 = 0;
  ...
  static SCALE_T hiddenStateDemote1 = 0; //1
  ...
  static SCALE_T hiddenStateDemote1 = 1;
