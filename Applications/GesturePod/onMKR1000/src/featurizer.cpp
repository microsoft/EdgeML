...
int Featurizer::featurize(int bucketDistribution[]){
    ...
    */
    ...
    bucketIndex=4;
    if((getBucket(this->ax, bucketDistribution))!=1) Serial.print("ERROR:1\n");
    if((getBucket(this->ay, bucketDistribution))!=1) Serial.print("ERROR:1\n");
    if((getBucket(this->az, bucketDistribution))!=1) Serial.print("ERROR:1\n");
    if((getBucket(this->gx, bucketDistribution))!=1) Serial.print("ERROR:1\n");
    if((getBucket(this->gy, bucketDistribution))!=1) Serial.print("ERROR:1\n");
    if((getBucket(this->gz, bucketDistribution))!=1) Serial.print("ERROR:1\n");
    return 1;
}
