...
import bonsaipreprocess_regression
...
from edgeml.trainer.bonsaiTrainer_regression import BonsaiTrainer
from edgeml.graph.bonsai_regression import Bonsai
...
def model_create():
    ...
    args = bonsaipreprocess_regression.getArgs()
    ...
    (dataDimension, numClasses,
        Xtrain, Ytrain, Xtest, Ytest,mean,std) = bonsaipreprocess_regression.preProcessData(data_dir)
