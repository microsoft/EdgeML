...
import sys
sys.path.insert(0, '../')
from edgeml.predictor.bonsaiPredictor_regression import bonsaiPredictor
from edgeml.predictor.bonsaiPredictorOptim_regression import bonsaiPredictorOptim
