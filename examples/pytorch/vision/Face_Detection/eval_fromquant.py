...
parser.add_argument('--image_dir', default=None, type=str, help='Folder containing image(s)')
parser.add_argument('--trace_file', default=None, type=str, help='File containing output traces')
parser.add_argument('--scale', type=str, default='-12', help='Scale for the output image (use scaleForY variable value from the generated m3dump/scales.h file here)')
