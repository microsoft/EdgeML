...
checkpoint_dict = torch.load('RNNPool_Face_QVGA_monochrome_best_state.pth')
...
i = 15
a = np.load('traces_rnnpool_face/trace_inputs_%d.npy' % i)
a = np.squeeze(a, axis = 1)
b = np.load('traces_rnnpool_face/trace_outputs_%d.npy' % i)
